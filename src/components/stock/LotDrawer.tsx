      ...
      <div className="drawer-panel" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="drawer-info-grid">
          ...
          <div>
            ...
            <input
              type="date"
              defaultValue={receipt?.sonKullanmaTarihi || ""}
              onChange={(e) => handleFieldSave("sonKullanmaTarihi", e.target.value)}
            />
          </div>
        </div>
        ...
        <div className="timeline">
          {receipt && (
            <div className="timeline-item timeline-giris">
              <span className="timeline-date">{row?.girisTarihi}</span>
