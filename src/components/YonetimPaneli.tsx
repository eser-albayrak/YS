...
export const AVAILABLE_PANELS: PanelPermission[] = [
  ...
  { key: "etiket", label: "3. Etiket Basım", group: "Operasyon", icon: "🏷️", desc: "Giriş kalite QR etiket üretimi" },
  { key: "cikis", label: "4. Depo Çıkışı (Sevkiyat)", group: "Operasyon", icon: "📤", desc: "Barkodlu düşüm ve sevkiyat" },
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button
              ...
              onClick={() => { setOpenSub1(true); setOpenSub2(true); setOpenSub3(true); setOpenSub4(true); }}
            >
              📂 Tüm Dalları Aç
            </button>
            <button
              type="button"
              className="btn-secondary btn-small"
              onClick={() => { setOpenSub1(false); setOpenSub2(false); setOpenSub3(false); setOpenSub4(false); }}
            >
              📁 Tüm Dalları Kapat
            </button>
          </div>
      ...
      <div style={{ position: "relative", paddingLeft: 22, display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        {/* 4. Alt Panel : İşlem Kayıtları (Audit Log) */}
        <div style={{ position: "relative" }}>
          {/* Yatay Dal Çizgisi */}
          <div
            style={{
