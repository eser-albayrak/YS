...
import type { AuxiliaryPart, Database } from "../types";
import {
  loadAuxiliaryParts,
  loadAuxiliaryDb,
...
export default function YardimciParcaStok() {
  ...
  const lotList = useMemo(() => {
    const list = Object.values(db.lots || {}).filter((l) => l.kalanMiktar > 0);
                            ...
                            <td style={{ textAlign: "center" }}>
                              <div style={{ display: "flex", gap: 6, justifyContent: "center" }}>
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    const availableLot = Object.values(db.lots || {}).find(
          ...
          <div className="modal-content" style={{ maxWidth: 500 }}>
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                ...
                <input
                  type="date"
                  value={girisForm.girisTarihi}
                  onChange={(e) => setGirisForm({ ...girisForm, girisTarihi: e.target.value })}
                />
              </div>
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    const availableLot = Object.values(db.lots || {}).find((l) => l.malzemeKodu === kod && l.kalanMiktar > 0);
                    setCikisForm({
                      ...cikisForm,
                      malzemeKodu: kod,
                      lotNo: availableLot ? availableLot.lotNo : "",
